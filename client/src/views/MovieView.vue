...
<template>
  <div v-if="movie!==null" class="tw_p-2 tw_mt-6">
    <div class="tw_text-center tw_mb-2">
      <h5>Movie #{{ movie.id }} | {{DateTime.fromISO(env.VITE_FIRST_DATE).plus({days: movie.id-1}).toFormat('DD')}}</h5>
    </div>
    <div>
      <div class="tw_aspect-video tw_bg-black tw_rounded tw_pointer-events-none tw_overflow-hidden">
        <img
          :src="imageUrl"
      ...
      <div class="tw_text-center tw_mt-2 tw_flex tw_gap-2 tw_justify-center">
        <q-btn
          v-for="i in 5"
          :key="i"
          dense
      ...
      <div class="tw_mt-6 tw_text-center">
        <div  v-if="state==='playing'">
          ...
          <div class="tw_flex tw_mt-4 tw_max-w-full">
            <q-select
              color="primary"
              v-model="guess"
        ...
        <div v-if="state!=='playing'" class="tw_flex tw_gap-2 tw_justify-center">
          <q-btn
            color="primary"
            label="Back to Home"
            size="md"
        ...
        <div class="tw_mt-6">
          ...
          <p
            v-if="state!=='playing'"
            class="tw_text-center tw_mt-2 tw_underline tw_cursor-pointer"
          ...
          >
            <div
              ...
              :key="i"
              class="tw_p-2 tw_flex tw_justify-start tw_items-center tw_gap-2"
            >
              <div
                class="tw_w-[16px] tw_h-[16px] tw_rounded "

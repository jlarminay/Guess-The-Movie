...
<template>
  <div class="tw_mt-6 tw_p-2">
    ...
    <p>
      GuessTheMovie is a small project I created as a personal endeavor to practice using some new
      tools, inspired by popular games like
      <a href="https://www.nytimes.com/games/wordle/index.html" target="_blank">Wordle</a>,
      <a href="https://guessthe.game/" target="_blank">GuessTheGame</a>,
      <a href="https://framed.wtf/" target="_blank">Framed</a>, and my own love of movies.
    </p>
    ...
    <p>
      Note: GuessTheMovie is an independent project and not affiliated with Film-grab or any movie
      studios. All rights belong to their respective owners.
    </p>
  </div>
</template>

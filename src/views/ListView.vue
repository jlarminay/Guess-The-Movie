...
<template>
  <div class="tw_mt-6 tw_p-2">
    <div class="tw_mb-10">
      ...
      />
      <div class="tw_text-center">{{ cleanedMovies.length }}/{{ allMovies.length }} movies</div>
    </div>

    <div>
      <div
        v-for="(movie, i) in cleanedMovies"
        :key="i"
        class="tw_mb-10 tw_flex tw_items-center tw_justify-between"
      >
        ...
        <div class="tw_w-[15%]">
          <img :src="image(movie.title, 2)" alt="" class="tw_h-full tw_w-full tw_object-contain" />
        </div>
        <div class="tw_w-[15%]">
          <img :src="image(movie.title, 3)" alt="" class="tw_h-full tw_w-full tw_object-contain" />
        </div>
        <div class="tw_w-[15%]">
          <img :src="image(movie.title, 4)" alt="" class="tw_h-full tw_w-full tw_object-contain" />
        </div>
        <div class="tw_w-[15%]">
          <img :src="image(movie.title, 5)" alt="" class="tw_h-full tw_w-full tw_object-contain" />
        </div>
      </div>

      <div class="tw_mb-10 tw_text-center">
        <q-btn label="Load More" color="primary" unelevated @click="loadMore" />
      </div>
    </div>
  </div>
</template>

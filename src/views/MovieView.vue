...
function checkGuess(skip = false) {
  // if no guess or skip is false, return
  ...
  <div v-if="movie !== null" class="tw_mt-6 tw_p-2">
    ...
    <div>
      <div class="tw_pointer-events-none tw_aspect-video tw_overflow-hidden tw_rounded tw_bg-black">
        <img :src="imageUrl" class="tw_h-full tw_w-full tw_object-contain" />
      </div>
      ...
      <div class="tw_mt-2 tw_flex tw_justify-center tw_gap-2 tw_text-center">
        <q-btn
          ...
          color="secondary"
          :label="i"
          :class="$q.screen.width > 400 ? 'tw_w-[40px]' : 'tw_w-[30px]'"
          :disable="move < i && state === 'playing'"
          @click="showImage = i"
        />
        <q-btn
          color="secondary"
          :label="$q.screen.width > 400 ? 'Skip >' : 'Skip'"
          no-caps
          unelevated
      ...
      <div class="tw_mt-6 tw_text-center">
        ...
        <div v-if="state === 'won'">
          ...
          <div class="tw_flex tw_justify-center">
            <div
              ...
              :class="
                i >= move ? (i > move ? 'tw_bg-[#6b7d95]' : 'tw_bg-positive') : 'tw_bg-negative'
              "
            />
          </div>
        </div>
        ...
        <div class="tw_mt-6">
          ...
          <div v-if="state === 'playing' || showGuesses">
            <div
